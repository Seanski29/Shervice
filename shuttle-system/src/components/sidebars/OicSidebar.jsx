...
export default function OicSidebar({ isSidebarOpen }) {
  ...
  const navItems = [
    { name: 'Dispatch Dashboard', icon: LayoutDashboard, path: '/oicmanage' },
    { name: 'Trip Details',       icon: Truck,           path: '/oictrips' },
    { name: 'Schedules',          icon: Calendar,        path: '/oicschedules' },
  ];
      ...
      <div className="p-6 flex items-center gap-3 border-b border-slate-700">
        ...
        {isSidebarOpen && (
          <div>
            ...
            <span className="text-xs text-slate-400">OIC Portal</span>
          </div>
        )}
      </div>
