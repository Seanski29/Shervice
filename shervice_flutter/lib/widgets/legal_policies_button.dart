...
class LegalPoliciesButton extends StatelessWidget {
  ...
  static void show(BuildContext context) {
    LegalPoliciesButton()._showLegalDialog(context);
  }
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // ─── I. PRIVACY NOTICE ───
                    _buildSectionTitle(context, 'I. PRIVACY NOTICE'),
                    _buildText(context,
                    ...
                    _buildSubsectionTitle(context, '1. Data Collection'),
                    _buildText(context,
                    ...
                    const SizedBox(height: 16),
                    _buildSubsectionTitle(context, '2. Purpose of Processing'),
                    _buildText(context,
                    ...
                    const SizedBox(height: 16),
                    _buildSubsectionTitle(context, '3. Data Protection Architecture'),
                    _buildText(context,
                    ...
                    // ─── II. TERMS & CONDITIONS ───
                    _buildSectionTitle(context, 'II. TERMS & CONDITIONS'),
                    _buildText(context,
                    ...
                    const SizedBox(height: 16),
                    _buildSubsectionTitle(context, '1. System Access and Authorization'),
                    _buildText(context,
                    ...
                    const SizedBox(height: 16),
                    _buildSubsectionTitle(context, '2. User Responsibilities'),
                    _buildText(context,
                    ...
                    const SizedBox(height: 16),
                    _buildSubsectionTitle(context, '3. Intellectual Property'),
                    _buildText(context,
                    ...
                    const SizedBox(height: 16),
                    _buildSubsectionTitle(context, '4. Limitation of Liability'),
                    _buildText(context,
                    ...
                    // ─── III. USER CONSENT ───
                    _buildSectionTitle(context, 'III. USER CONSENT'),
                    _buildText(context,
                    ...
                    const SizedBox(height: 16),
                    _buildSubsectionTitle(context, 'Authorization for Processing'),
                    _buildText(context,
                    ...
                    const SizedBox(height: 16),
                    _buildSubsectionTitle(context, 'Compliance with Policy'),
                    _buildText(context,
                    ...
                    const SizedBox(height: 16),
                    _buildSubsectionTitle(context, 'Data Integrity'),
                    _buildText(context,
                    ...
                    const SizedBox(height: 16),
                    _buildSubsectionTitle(context, 'Privacy Rights'),
                    _buildText(context,
                    ...
                    const SizedBox(height: 16),
                    _buildSubsectionTitle(context, 'Security Vigilance'),
                    _buildText(context,
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              spacing: 4,
              children: [
                TextButton(onPressed: () => LegalPoliciesButton.show(context), child: Text('Terms of Service', style: linkStyle)),
                TextButton(onPressed: () => LegalPoliciesButton.show(context), child: Text('Privacy Notice', style: linkStyle)),
                TextButton(onPressed: () => LegalPoliciesButton.show(context), child: Text('User Consent', style: linkStyle)),
              ],
            ),
          ],
        ),
