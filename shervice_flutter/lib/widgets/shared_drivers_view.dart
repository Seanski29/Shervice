...
class SharedDriversViewState extends State<SharedDriversView> {
  ...
  String get _backendFetchUrl {
    ...
    return Platform.isAndroid ? 'http://10.0.2.2:5000/api/test-db' : 'http://127.0.0.1:5000/api/test-db';
  }
  ...
  Future<void> _fetchDriversFromDatabase() async {
    ...
    try {
      final response = await http.get(Uri.parse(_backendFetchUrl)).timeout(const Duration(seconds: 10));
              ...
              Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    ...
                    items: _sortOptions.map((s) => DropdownMenuItem<String>(value: s, child: Text(s))).toList(),
                    onChanged: (val) {
                      if (val != null) {
                        _currentSort = val;
                        _applyFiltersAndSort();
                ...
                : _filteredDrivers.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final Color statusColor = (driver.status == 'Active') ? Colors.green : Colors.orange;
                          ...
                          return Container(
                            ...
                            child: Material(
                              ...
                              child: ListTile(
                                ...
                                title: Text(driver.name, style: const TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF0F172A), fontSize: 16)),
                                subtitle: Padding(
                                      ...
                                      Row(
                                        children: [
                                          Container(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                Text(driver.rating.toString(), style: const TextStyle(fontSize: 11, fontWeight: FontWeight.bold)),
                                              ],
                                            ),
                                          ),
                                          ...
                                          Container(
                                            ...
                                            child: Text(driver.status, style: TextStyle(color: statusColor, fontSize: 11, fontWeight: FontWeight.bold)),
                                          ),
                                        ],
                                      ),
                                      const SizedBox(height: 6),
                                      Text("License: ${driver.licenseNumber} • Expiry: ${driver.licenseExpiry}", style: TextStyle(color: Colors.grey.shade600, fontSize: 12)),
                                    ],
                                  ),
                                ),
