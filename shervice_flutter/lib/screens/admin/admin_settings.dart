                ...
                child: isSuccess
                    ? Column(
                        ...
                        children: [
                          ...
                          Text('Password Updated!', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: textColor)),
                          const SizedBox(height: 8),
                          Text('Your administrator password has been changed successfully.', textAlign: TextAlign.center, style: TextStyle(color: subTextColor, fontSize: 14)),
                    ...
                    : Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text('Change Password', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: textColor)),
                            const SizedBox(height: 16),
                            TextFormField(
                              ...
                              children: [
                                ...
                                ElevatedButton(
                                      ...
                                      : () async {
                                          ...
                                          try {
                                            final response = await http.post(
                                              ...
                                              body: jsonEncode({'user_id': widget.adminId, 'new_password': passwordController.text}),
                                  ...
                                  child: isUpdating
                                      ...
                                      : const Text('Update Password', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 13)),
                                ),
                              ],
                            ),
                          ],
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      'Account Settings',
                      style: TextStyle(fontSize: 24, fontWeight: FontWeight.w800, color: textColor, letterSpacing: -0.5), // Dynamic Text
                    ),
                    const SizedBox(height: 4),
                    Text(
                      'Manage your profile, security, and preferences.',
                      style: TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: subTextColor), // Dynamic Subtext
                    ),
                  ],
                ),
              ),
            ...
            child: Wrap(
              ...
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Admin System', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: textColor)),
                    const SizedBox(height: 2),
                    Text('Administrator Account', style: TextStyle(fontSize: 13, color: subTextColor)),
                    const SizedBox(height: 4),
                    Container(
          ...
          Container(
            ...
            child: ListTile(
              ...
              title: Text('Change Password', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14, color: textColor)),
              subtitle: Text('Update your administrator password', style: TextStyle(fontSize: 12, color: subTextColor)),
              trailing: Icon(Icons.chevron_right, color: subTextColor, size: 20),
              onTap: () => _showChangePasswordModal(context, isDark), // Pass isDark so the modal matches!
            ),
          ),
          const SizedBox(height: 20),
